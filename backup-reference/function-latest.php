...
function add_child_theme_stylesheets()
{
    ...
    if (is_page('acoustiq')) {
        wp_enqueue_style('base-style', get_stylesheet_directory_uri() . '/assets/css/base.css', array(), $theme_version, 'all');
        wp_enqueue_style('carousel-style', get_stylesheet_directory_uri() . '/assets/css/carousel.css', array(), $theme_version, 'all');
        wp_enqueue_style('colorrange-style', get_stylesheet_directory_uri() . '/assets/css/colorrange.css', array(), $theme_version, 'all');
        wp_enqueue_style('header-style', get_stylesheet_directory_uri() . '/assets/css/header.css', array(), $theme_version, 'all');
        wp_enqueue_style('literature-style', get_stylesheet_directory_uri() . '/assets/css/literature.css', array(), $theme_version, 'all');
        wp_enqueue_style('popup-style', get_stylesheet_directory_uri() . '/assets/css/popup.css', array(), $theme_version, 'all');
        wp_enqueue_style('responsive-style', get_stylesheet_directory_uri() . '/assets/css/responsive.css', array(), $theme_version, 'all');
        wp_enqueue_style('showcase-style', get_stylesheet_directory_uri() . '/assets/css/showcase.css', array(), $theme_version, 'all');
        wp_enqueue_style('support-style', get_stylesheet_directory_uri() . '/assets/css/support.css', array(), $theme_version, 'all');
        wp_enqueue_style('technical-style', get_stylesheet_directory_uri() . '/assets/css/technical.css', array(), $theme_version, 'all');
        wp_enqueue_script(
            'acoustiq-script',
